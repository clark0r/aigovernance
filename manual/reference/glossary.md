...
- **ADM / ADMT** — Automated Decision-Making / Automated Decisionmaking Technology
- **AEDT** — Automated Employment Decision Tool (NYC Local Law 144)
- **BAA** — Business Associate Agreement (HIPAA)
- **CIIO** — Critical Information Infrastructure Operator (China)
- **DPA** — Data Processing Agreement; also "Data Protection Authority" depending on context
- **DPIA** — Data Protection Impact Assessment (GDPR Art. 35)
- **DPIR / RIPD** — Data Protection Impact Report (Brazil LGPD)
- **DPO** — Data Protection Officer
- **GPAI** — General-Purpose AI (model/system) under the EU AI Act
- **PCCP** — Predetermined Change Control Plan (FDA, AI/ML medical devices)
- **PHI** — Protected Health Information (HIPAA)
- **PIA / PIPIA** — Privacy Impact Assessment / Personal Information Protection Impact Assessment (China PIPL)
- **PII** — Personally Identifiable Information
- **RoPA** — Records of Processing Activities (GDPR Art. 30)
- **SaMD** — Software as a Medical Device
- **SBOM** — Software Bill of Materials
- **SPI** — Sensitive Personal Information (CCPA/CPRA)
...
- **UK:** UK GDPR / DPA 2018 / Data (Use and Access) Act 2025, Online Safety Act 2023
- **Canada:** PIPEDA, Quebec Law 25, Bill C-36 (PPCDA, pending)
- **Brazil:** LGPD, PL 2338/2023 (Marco Legal da IA, pending)
- **China:** PIPL + Cybersecurity Law + Data Security Law ("data trinity"); Generative AI Measures; Deep Synthesis Provisions; Algorithmic Recommendation Provisions
- **Japan:** APPI
- **South Korea:** PIPA; AI Basic Act (2025)
- **Singapore:** PDPA; Model AI Governance Framework; Generative AI Model Framework; AI Verify
- **India:** DPDP Act 2023
